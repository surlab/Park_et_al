...
#%% Run the decoder for small population sizes (upto 10)
...
for csvFile in csvFiles:
    ...
    if nUnits >= 10:
        ...
        fileName = sessionName + '_auc_scores_3.csv'     
        
        resultsDF.to_csv(saveFolder+fileName)
        print('Saved %s' % (sessionName))
    else:
        print('Skipping %s due to insufficient nUnits' % (sessionName))
...
fileName = 'Decoder_AUC_gratings_mas_3.csv'    
